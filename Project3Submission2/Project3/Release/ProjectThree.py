# Erika M. Alexander
# CS210 Project Three Submission
...
#Description: To call this function, pass the function name into the CallProcedure function.
#Example: callProcedure("CountAll");
#Output: Returns a list of all unique items in CS210, and prints all of their occurrances.
#Return: None
...
#Description: To call this function, pass this function into the CallIntFunc function along with the desired search term.
#Example: callIntFunc("CountInstances", searchTerm);
#Output: Returns the number of occurrances of the desired search term.
...
#Description: To call this function, pass this function into the CallProcedure function.
#Example: callProcedure("CollectData");
#Output: Returns a a document (frequency.dat) with each unique word and the number of times that word occurs..
