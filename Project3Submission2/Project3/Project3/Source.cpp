...
/*
Description: When this function is called, it will produce a menu to prompt user input.
Example: DrawMenu();
Output: Outputs a menu that will take user input between 1-4. User input will then execute the appropriate Python function.
